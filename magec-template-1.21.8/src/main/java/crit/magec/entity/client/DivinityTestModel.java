...
public class DivinityTestModel extends EntityModel<DivinityTestRenderState  > {
    ...
    public static TexturedModelData getTexturedModelData() {
        ...
        ModelPartData head = bone.addChild("head", ModelPartBuilder.create().uv(0, 0).cuboid(-16.0F, -48.0F, -8.0F, 32.0F, 48.0F, 16.0F, new Dilation(0.0F)), ModelTransform.rotation(0.0F, 0.0F, 0.0F));
